...
<body style="min-height: 100%;" class="">
    ...
    <div class="container py-5 min-h-100 position-relative">
        <div class="d-flex justify-content-center">
            <img class="drop-shadow" src="https://geomapping.da.gov.ph/prdp/assets/img/prdp_rz.png" alt="" style="max-width: 130px;">
        </div>
        ...
        <div class="section-title ps-lg-2 d-flex flex-column flex-lg-row justify-content-between align-items-start">
            Our Portfolio
            <a href="https://geomapping.da.gov.ph/prdp/sidlan/d2-portfolio" target="_blank" class="btn btn-primary d-none d-lg-block dashboard-redirect">View Detailed Data</a>
        </div>

        <div class="row d-block d-lg-none">
            <div class="col-12">
                <a href="https://geomapping.da.gov.ph/prdp/sidlan/d2-portfolio" target="_blank" class="btn btn-primary btn-sm my-2">View Detailed Data</a>
            </div>
        </div>
