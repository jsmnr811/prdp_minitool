        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content rounded-2xl shadow-lg">
                ...
                <div class="modal-header border-b">
                    <h5 class="modal-title font-semibold text-lg" id="assignUserLabel">Assign Role, Group Number, and Table Number</h5>
                    ...
                    <div class="modal-body space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                ...
                                @if ($role == 1)
                                <div>
                                    <label class="text-sm font-medium">Is I-PLAN? <span class="text-red-500">*</span></label>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    <label class="text-sm font-medium">Group Number <span class="text-red-500">*</span></label>
