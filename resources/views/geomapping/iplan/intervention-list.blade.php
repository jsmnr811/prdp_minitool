<x-layouts.geomapping.iplan.app>
    @push('breadcrumbs')
        <li class="breadcrumb-item active text-primary fw-semibold" aria-current="page">Intervention Management
        </li>
    @endpush
    <div class="row g-4">
        <div class="col-lg-12">
            <div class="card shadow-sm">
                <div class="card-header p-3 d-flex justify-content-end align-items-center">
