        ...
        <div class="col-lg-12">
            <div class="card shadow-sm">
                <div class="card-header p-3 d-flex justify-content-end align-items-center gap-3">
                    ...
                    <a href="{{ route('geomapping.iplan.investment.user-dashboard') }}"
                        class="btn btn-success d-flex align-items-center">
    ...
    @push('styles')
        ...
        <style>
            ...
            .dataTables_length select {
                ...
                border-radius: 0.375rem;
                border: 1px solid #ced4da;
                background: #fff url("data:image/svg+xml;charset=UTF8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3e%3cpath fill='none' stroke='%236c757d' stroke-width='.5' d='M2 0L0 2h4zm0 5L03h4z'/%3e%3c/svg%3e") no-repeat right 0.75rem center/8px 10px;
                -webkit-appearance: none;
                -moz-appearance: none;
                appearance: none;
                color: #212529;
