...
<div style="width:100vw; height:100vh; display:flex; justify-content:center; align-items:center; background:#f0f0f0;">
    <div style="width:{{ $baseWidth * $scale }}px; height:{{ $baseHeight * $scale }}px; position:relative; overflow:hidden; background:#fff; border-radius:10px; box-shadow:0 0 20px rgba(0,0,0,0.2);">
        ...
        <div style="position:relative; z-index:1; display:flex; flex-direction:column; align-items:center; justify-content:flex-start; padding:{{ 20 * $scale }}px;">
            ...
            <div style="display:flex; flex-direction:column; align-items:center; margin-top:45px;">
                <div style="text-align:center; margin-top:0px; white-space:nowrap; overflow:hidden; padding-left:{{ 4 * $scale }}px; padding-right:{{ 4 * $scale }}px;">
                    <div style="font-family:'Arial Black', Arial, sans-serif; font-size:{{ $firstFontSize }}px; font-weight:900; color:#2f4482; line-height:1.1; margin-left: 50px;  margin-right: 50px;">
                        {{ $firstName }}
                    </div>
        ...
        <div style=" position: relative;  width: 100%; margin-top: 20px; border-radius: 8px; min-height: 500px;
                    display: flex; flex-direction: column; justify-content: center; align-items: center; padding-bottom: {{ 20 * $scale }}px;">

            <!-- Designation: dynamic -->
            <div style=" margin-bottom: 5px; color: #2f4482; font-family: Arial, sans-serif; font-size: {{ $fontSize }}px; line-height:1;
        ...
        <div style="position:absolute; bottom:600px; left:50%; transform:translateX(-50%); display:flex; align-items:center; gap:20px; z-index:2;">

            <!-- QR Code -->
            <div style="width:{{ $qrSize }}px; height:{{ $qrSize }}px; display:flex; justify-content:center; align-items:center;">
            ...
            <!-- ID Number -->
            <div style="font-family:'NeulisSansBold', Arial, sans-serif; line-height:1.2; text-align:left; margin-top: 50px;">
                <div style="font-family:Arial, sans-serif; font-size:{{ $idFontSize }}px; color:#2f4482; font-weight:700;">ID No:</div>
                <div style="font-family:Arial, sans-serif; font-size:{{ $idFontSize }}px; color:#2f4482; font-weight:800;">
                    {{ $user->login_code }}
                </div>
            </div>
