<aside
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2">
            ...
            <x-flowbite.aside-menu title="User Management" link="{{ route('users') }}" :wireNavigate="true">
                <x-slot:icon>
            ...
            </x-flowbite.aside-menu>
            <x-flowbite.aside-menu title="Products" link="{{ route('products') }}" :wireNavigate="true">
                <x-slot:icon>
                    <svg class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            @endif
            <x-flowbite.aside-menu title="Marketplace" link="{{ route('marketplace') }}" :wireNavigate="true">
                <x-slot:icon>
                    <svg class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
